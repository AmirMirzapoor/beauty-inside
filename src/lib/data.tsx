import type { NavLink, Service, GalleryImage, Artist, PortfolioItem, SocialLink } from "@/components/common/types";
...
export const services: Service[] = [
    { id: 1, slug: 'hair-services', icon: <GiHairStrands size={30} />, title: "خدمات مو", description: "انواع کوتاهی، رنگ و لایت، کراتین و احیای مو." },
    { id: 2, slug: 'nail-services', icon: <TbBrandDaysCounter size={30} />, title: "خدمات ناخن", description: "مانیکور، پدیکور، کاشت و طراحی ناخن." },
    { id: 3, slug: 'makeup-services', icon: <GiSpikedDragonHead size={30} />, title: "میکاپ و گریم", description: "میکاپ حرفه‌ای عروس، گریم سینمایی." },
    { id: 4, slug: 'skincare-services', icon: <GiLotus size={30} />, title: "خدمات پوست", description: "فیشیال تخصصی، پاکسازی و آبرسانی." },
];
...
export const portfolioItems: PortfolioItem[] = [
    ...
    // More hair services by another artist (to show variety)
    { id: 9, image: "/images/portfolio/hair3.jpg", serviceSlug: 'hair-services', artistId: 3 },
];

// --- DATA ACCESS FUNCTIONS (Our Mini API) ---
export const getServiceBySlug = (slug: string) => services.find(s => s.slug === slug);
export const getArtistById = (id: number) => artists.find(a => a.id === id);
export const getPortfolioItemsByService = (slug: string) => portfolioItems.filter(p => p.serviceSlug === slug);
export const getPortfolioItemsByArtist = (id: number) => portfolioItems.filter(p => p.artistId === id);
