    ...
    <div className="bg-background-light">
      ...
      <main className="min-h-screen pt-24">
        <section className="bg-background-section py-16 text-center">
          <div className="container mx-auto px-6">
            <MotionWrapper
              ...
              className="mb-4 inline-block rounded-full bg-accent-pink/20 p-4 text-accent-pink"
            >
              {service.icon}
            </MotionWrapper>
            <MotionWrapper variants={itemVariants} transition={{ delay: 0.2 }}>
              <h1 className="text-4xl font-bold text-brand-green-dark md:text-5xl">
                {service.title}
              </h1>
            </MotionWrapper>
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            <h2 className="mb-12 text-center text-3xl font-bold text-brand-green-dark">
              نمونه‌کارها
            </h2>
                      ...
                      <div className="bg-white p-6">
                        {artist && (
                          <Link
                            ...
                            className="group/artist flex items-center gap-3"
                          >
